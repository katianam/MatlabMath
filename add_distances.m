function [outputArg1,outputArg2] = add_distances(Acr, currentsideletter)
...
a = max(Acr{1,6});
vessel_lengths = zeroes(max(Acr{1,6}));
curr_parent = 1;


%for each parent, add lengths between nodes to get total length to terminus
